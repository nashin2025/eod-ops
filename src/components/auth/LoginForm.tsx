    ...
    <div className="min-h-screen flex items-center justify-center p-4 animate-fade-in" style={{ background: 'hsl(var(--background))' }}>
      <Card className="w-full max-w-md card-neo dark:card-mono animate-slide-up">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-muted-foreground">Sign in to your EOD-Ops account</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex flex-col gap-2">
          <p className="text-center text-sm text-muted-foreground">
            ...
            <a href="/register" className="text-accent hover:underline font-medium dark:text-accent-dark">
              Sign up
            </a>
          </p>
          <p className="text-center text-sm text-muted-foreground">
            <a href="/forgot-password" className="text-accent hover:underline dark:text-accent-dark">
              Forgot password?
            </a>
          </p>
        </CardFooter>
